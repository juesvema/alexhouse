...
class IdiomasControllerTest < ActionController::TestCase
  ...
  test "should create idioma" do
    assert_difference('Idioma.count') do
      post :create, idioma: { idioma: @idioma.idioma, imagen: @idioma.imagen, modalidad: @idioma.modalidad }
    end
  ...
  test "should update idioma" do
    patch :update, id: @idioma, idioma: { idioma: @idioma.idioma, imagen: @idioma.imagen, modalidad: @idioma.modalidad }
    assert_redirected_to idioma_path(assigns(:idioma))
  end
